...
resource subnet 'Microsoft.Network/virtualNetworks/subnets@2021-05-01' = if (isprod) {
  parent: vnet
  name: subnetName
  properties: {
...
resource mysqlDbServer 'Microsoft.DBforMySQL/servers@2017-12-01' = {
  ...
  resource virtualNetworkRule 'virtualNetworkRules@2017-12-01' =  if (isprod) {
...
output mysqlresourceid string = mysqlDbServer.id
